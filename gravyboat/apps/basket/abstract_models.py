...
from gravyboat.apps.basket.managers import OpenBasketManager, SavedBasketManager
from gravyboat.apps.offer import results
from gravyboat.apps.partner import availability
from gravyboat.core.compat import AUTH_USER_MODEL
from gravyboat.core.utils import get_default_currency
    ...
    def _get_strategy(self):
        if not self.has_strategy:
            raise RuntimeError(
                ...
                "gravyboat.apps.basket.middleware.BasketMiddleware. "
