...
from gravyboat.apps.wishlists.models import WishList, Line
from gravyboat.apps.catalogue.models import Product
from gravyboat.apps.wishlists.forms import WishListForm, LineFormset
from gravyboat.apps.customer.mixins import PageTitleMixin
