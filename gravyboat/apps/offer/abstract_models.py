...
from gravyboat.apps.offer import results, utils
from gravyboat.apps.offer.managers import ActiveOfferManager
from gravyboat.core.compat import AUTH_USER_MODEL
from gravyboat.core.loading import get_class, get_model
from gravyboat.models import fields
from gravyboat.templatetags.currency_filters import currency


from gravyboat.apps.offer.managers import BrowsableRangeManager
...
class AbstractBenefit(models.Model):
    ...
    def proxy(self):
        from gravyboat.apps.offer import benefits
...
class AbstractCondition(models.Model):
    ...
    def proxy(self):
        ...
        """
        from gravyboat.apps.offer import conditions
