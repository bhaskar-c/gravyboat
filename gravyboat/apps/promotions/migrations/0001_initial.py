    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link_url', gravyboat.models.fields.ExtendedURLField(verbose_name='Link URL', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link_url', gravyboat.models.fields.ExtendedURLField(verbose_name='Link URL', help_text='This is where this promotion links to', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('clicks', models.PositiveIntegerField(default=0, verbose_name='Clicks')),
                ('date_created', models.DateTimeField(auto_now_add=True, verbose_name='Date Created')),
                ('page_url', gravyboat.models.fields.ExtendedURLField(max_length=128, verify_exists=True, db_index=True, verbose_name='Page URL')),
                ('content_type', models.ForeignKey(to='contenttypes.ContentType')),
            ],
            options={
                'ordering': ['-clicks'],
