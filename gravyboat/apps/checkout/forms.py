...
from gravyboat.apps.address.forms import AbstractAddressForm
...
class ShippingAddressForm(PhoneNumberMixin, AbstractAddressForm):
    ...
    class Meta:
        from gravyboat.apps.order.models import ShippingAddress as model
        fields = [
...
# The BillingAddress form is in gravyboat.apps.payment.forms
