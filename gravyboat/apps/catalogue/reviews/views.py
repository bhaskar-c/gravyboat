...
from gravyboat.apps.catalogue.reviews.signals import review_added
from gravyboat.core.loading import get_classes, get_model
from gravyboat.core.utils import redirect_to_referrer


from gravyboat.apps.catalogue.reviews.forms import ProductReviewForm,VoteForm, SortReviewsForm
# ProductReviewForm, VoteForm, SortReviewsForm = get_classes(
#     'catalogue.reviews.forms',
#     ['ProductReviewForm', 'VoteForm', 'SortReviewsForm'])
from gravyboat.apps.catalogue.reviews.models import Vote, ProductReview
