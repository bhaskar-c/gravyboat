...
from gravyboat.core.utils import slugify
from gravyboat.core.validators import non_python_keyword
from gravyboat.models.fields import AutoSlugField, NullCharField

from gravyboat.apps.catalogue.managers import ProductManager, BrowsableProductManager
...
class MissingProductImage(object):
    ...
    def symlink_missing_image(self, media_file_path):
        static_file_path = find('gravyboat/img/%s' % self.name)
