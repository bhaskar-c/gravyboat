...
from gravyboat.apps.dashboard.pages import forms
from gravyboat.core.loading import get_model
from gravyboat.core.utils import slugify
from gravyboat.core.validators import URLDoesNotExistValidator
...
class PageCreateView(generic.CreateView):
    ...
    def get_success_url(self, page):
        msg = render_to_string('gravyboat/dashboard/pages/messages/saved.html',
                               {'page': page})
