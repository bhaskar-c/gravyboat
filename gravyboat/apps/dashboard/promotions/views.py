...
from gravyboat.core.loading import get_classes

from gravyboat.apps.promotions.models import SingleProduct, RawHTML, Image, MultiImage, AutomaticProductList, \
    PagePromotion, HandPickedProductList
from gravyboat.apps.dashboard.promotions.forms import PromotionTypeSelectForm as SelectForm
from gravyboat.apps.dashboard.promotions.forms import RawHTMLForm, PagePromotionForm, HandPickedProductListForm, \
