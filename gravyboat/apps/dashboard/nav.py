...
from gravyboat.core.loading import AppNotFoundError, get_class
from gravyboat.views.decorators import check_permissions
...
def default_access_fn(user, url_name, url_args=None, url_kwargs=None):
    ...
    # string (e.g. 'gravyboat.apps.dashboard.catalogue.views') into an app
