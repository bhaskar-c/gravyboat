...
from gravyboat.core.exceptions import (
...
def get_classes(module_label, classnames):
    ...
    Examples:
        ...
        gravyboat.apps.dashboard.catalogue.forms.ProductForm
        ...
        [gravyboat.apps.dashboard.catalogue.forms.ProductForm,
         gravyboat.apps.dashboard.catalogue.forms.StockRecordForm]
    ...
    # import from gravyboat package (should succeed in most cases)
    # e.g. 'gravyboat.apps.dashboard.catalogue.forms'
    gravyboat_module_label = "gravyboat.apps.%s" % module_label
    gravyboat_module = _import_module(gravyboat_module_label, classnames)

    # returns e.g. 'gravyboat.apps.dashboard.catalogue',
    ...
    if installed_apps_entry.startswith('gravyboat.apps.'):
    ...
    if gravyboat_module is local_module is None:
    ...
    return _pluck_classes([local_module, gravyboat_module], classnames)
...
def feature_hidden(feature_name):
    ...
    return (feature_name is not None and
            feature_name in settings.GRAVYBOAT_HIDDEN_FEATURES)
