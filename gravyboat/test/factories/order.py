...
from gravyboat.test.factories.utils import tax_add, tax_subtract
...
class BillingAddressFactory(factory.DjangoModelFactory):
    country = factory.SubFactory('gravyboat.test.factories.CountryFactory')
...
class OrderFactory(factory.DjangoModelFactory):
    ...
    basket = factory.SubFactory(
        'gravyboat.test.factories.BasketFactory')
...
class OrderLineFactory(factory.DjangoModelFactory):
    ...
    product = factory.SubFactory(
        'gravyboat.test.factories.ProductFactory')
