...
from gravyboat.core import validators
from gravyboat.forms import fields

import gravyboat.core.phonenumber as phonenumber
# allow importing as gravyboat.models.fields.AutoSlugField
...
class PhoneNumberField(six.with_metaclass(SubfieldBase, CharField)):
    ...
    * Displays it nicely formatted
    ...
    See ``gravyboat/core/phonenumber.py`` for the relevant copyright and
    permission notice.
    """
